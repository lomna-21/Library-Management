...
public class Constants {
    ...
    public static final String CREATE_AUTHOR_AUTHORITY = "CREATE_AUTHOR";
    ...
    public static final String ADMIN_CACHE_KEY_PREFIX = "ad::";
    public static final Integer ADMIN_CACHE_KEY_EXPIRY = 600;

    public static final String BOOK_CACHE_KEY_PREFIX = "bk::";
    public static final Integer BOOK_CACHE_KEY_EXPIRY = 600;

    public static final String TRANSACTION_CACHE_KEY_PREFIX = "txn::";
    public static final Integer TRANSACTION_CACHE_KEY_EXPIRY = 600;

    public static final String AUTHOR_CACHE_KEY_PREFIX = "auth::";
    public static final Integer AUTHOR_CACHE_KEY_EXPIRY = 600;
